...
<dl>
  ...
  <dd>
    Field classification, "string" by default. There are <a href="#default-fieldinput-components">standard types</a> as well as custom.  A custom type can be <i>any</i> string, ex. "collection", "com.jcatalog.core.DateRange", etc.
    <br /><br />

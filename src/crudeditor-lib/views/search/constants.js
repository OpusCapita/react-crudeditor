...
export const
  ...
  INSTANCES_CUSTOM_ACTION_INITIALIZATION = namespace + '/INSTANCES_CUSTOM_ACTION_INITIALIZATION',
  INSTANCES_CUSTOM_ACTION_FINALIZATION = namespace + '/INSTANCES_CUSTOM_ACTION_FINALIZATION',

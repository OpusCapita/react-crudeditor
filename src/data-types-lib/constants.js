export const
  COMPONENT_API_TYPE_BOOLEAN = 'boolean',  // JavaScript type "boolean".
  COMPONENT_API_TYPE_NUMBER = 'number',    // JavaScript type "number".
  COMPONENT_API_TYPE_STRING = 'string',    // JavaScript type "string".
  ...
  FIELD_TYPE_NUMBER = 'number',   // JavaScript type "string" with number of any size.
  ...
  ERROR_UNKNOWN_COMPONENT_API_TYPE = 'unknownComponentApiTypeError',

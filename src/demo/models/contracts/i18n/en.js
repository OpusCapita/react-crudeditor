export default {
  ...
  "model.field.description.hint": "Provide a detailed description for this contract.",
  "model.field.description.tooltip": "Arbitrary description of your choice.",
  "model.field.description.error.forbiddenWord": "Description may not contain `{forbiddenWord}`",

  "model.field.statusId.hint": "Refer to a secret book of status codes for details.",
  ...
  "model.error.requiredFieldMissing": "I'm a happy instance validation error for [ {contractId} ]!"
}
